...
// //     video: '/polyglo.mp4',  // Changed to public folder reference
// //     image: '/polygloss.png'
// //   },
// //   {
...
// //     video: '/resumepert.mp4',
// //     image: '/resumexpertss.png'
// //   },
// //   {
...
// //   return (
// //     <section id="projects" ref={ref} className="min-h-screen px-6 max-w-7xl mx-auto py-24 bg-light-bg dark:bg-dark-bg">
// //       <animated.div style={fadeIn}>
// //         <h2 className="text-3xl font-bold text-textLight-heading dark:text-text-heading mb-16 flex items-center justify-center md:justify-start">
...
// //                 <div 
// //                   className="bg-light-card dark:bg-dark-card border border-border-light dark:border-border-dark rounded-lg overflow-hidden hover:border-accent-primary dark:hover:border-accent-primaryDark/50 transition-all duration-300 group cursor-pointer shadow-md hover:shadow-xl"
// //                   onClick={() => openModal(project)}
// //                 >
// //                   <div className="relative overflow-hidden h-64 bg-light-elevated dark:bg-dark-elevated flex items-center justify-center">
// //                     <div className="text-6xl text-accent-primary/20 dark:text-accent-primaryDark/20 font-mono">{"{ }"}</div>
// //                     <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-light-card/90 dark:bg-dark-bg/90 backdrop-blur-sm z-20">
...
// //                     <h3 className="text-2xl font-bold text-textLight-heading dark:text-text-heading mb-3 group-hover:text-accent-primary dark:group-hover:text-accent-primaryDark transition-colors">
// //                       {project.title}
// //                     </h3>
// //                     <p className="text-textLight-secondary dark:text-text-secondary text-sm leading-relaxed mb-4 line-clamp-3">
// //                       {project.shortDesc}
// //                     </p>

// //                     <div className="flex flex-wrap gap-2 mb-4">
// //                       {project.tech.map(tech => (
// //                         <span key={tech} className="text-xs font-mono text-textLight-secondary dark:text-text-secondary bg-light-elevated dark:bg-dark-elevated px-3 py-1 rounded">
// //                           {tech}
// //                         </span>
// //                       ))}
// //                     </div>
...
// //         className="max-w-4xl mx-auto mt-20 mb-20 p-8 bg-light-card dark:bg-dark-card rounded-lg border border-border-light dark:border-border-dark outline-none max-h-[90vh] overflow-y-auto"
...
// //                 <h2 className="text-3xl font-bold text-textLight-heading dark:text-text-heading">{selectedProject.title}</h2>
// //               </div>
// //               <button
// //                 onClick={closeModal}
...
// //             <p className="text-textLight-secondary dark:text-text-secondary text-lg leading-relaxed mb-6">
...
// //                   <li key={idx} className="flex items-start text-textLight-secondary dark:text-text-secondary">
...
// //                   <span key={tech} className="font-mono text-sm text-textLight-secondary dark:text-text-secondary bg-light-elevated dark:bg-dark-elevated px-4 py-2 rounded">
// //                     {tech}
// //                   </span>
// //                 ))}
// //               </div>
...
// //             <div className="flex gap-4 pt-6 border-t border-border-light dark:border-border-dark">
// //               <a
// //                 href={selectedProject.github}
// //                 target="_blank"
// //                 rel="noopener noreferrer"
// //                 className="flex items-center gap-2 px-6 py-3 border border-accent-primary dark:border-accent-primaryDark text-accent-primary dark:text-accent-primaryDark rounded hover:bg-accent-primary/10 dark:hover:bg-accent-primaryDark/10 transition-all font-mono"
// //               >
// //                 <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
// //                   <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
// //                 </svg>
...
//                   <div className="relative overflow-hidden h-64 bg-light-elevated dark:bg-dark-elevated">
//                     <img 
//                       src={project.image} 
//                       alt={project.title}
            ...
            {projects.map((project, idx) => (
              <div key={idx} className="px-4">
                <div 
                  ...
                  onClick={() => openModal(project)}
                >
                  {/* Project Image with Hover Overlay - Increased Height */}
                  <div className="relative overflow-hidden h-72 bg-light-elevated dark:bg-dark-elevated">
                    <img 
                      src={project.image} 
                      alt={project.title}
                      className="w-full h-full object-cover"
