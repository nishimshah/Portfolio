...
// // //   github: 'https://github.com/s-dudhiya/Rewear-Community-Clothing-Exchange',  // Fixed
// // //   video: 'https://drive.google.com/file/d/1OVqaqqY-sF02d4YlqxA8_YCBm5jhnRdi/preview',  // Fixed
// // //   image: '/rewearss.jpg'
// // //   },
...
// // //             {/* Video Player Section - Supports both Google Drive and local videos */}
...
// // //                   </div>
// // //                 ) : (
// // //                   // Regular video tag for local files
...
// //           {projects.map((project, idx) => (
// //             <ProjectCard key={idx} project={project} openModal={openModal} />
// //           ))}
// //         </div>
// //       </animated.div>
...
// //       onClick={() => openModal(project)}
// //     >
// //       <div className="relative overflow-hidden h-48 md:h-72 bg-light-elevated dark:bg-dark-elevated">
// //         <img 
// //           src={project.image} 
// //           alt={project.title}
// //           className="w-full h-full object-cover"
...
// //         <div className="text-accent-primary dark:text-accent-primaryDark font-mono text-xs mb-2">Featured Project</div>
// //         <h3 className="text-xl md:text-2xl font-bold text-textLight-heading dark:text-text-heading mb-2 md:mb-3 group-hover:text-accent-primary dark:group-hover:text-accent-primaryDark transition-colors">
// //           {project.title}
// //         </h3>
// //         <p className="text-textLight-secondary dark:text-text-secondary text-sm leading-relaxed mb-4 line-clamp-2 md:line-clamp-3">
// //           {project.shortDesc}
// //         </p>
