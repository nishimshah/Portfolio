          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-2">
              <div className="relative group max-w-sm mx-auto">
                <div className="absolute inset-0 bg-gray-900 dark:bg-white opacity-10 rounded-2xl blur-xl group-hover:blur-2xl transition-all pointer-events-none"></div>
                ...
                <div className="flex items-center justify-center gap-3 mt-4 relative z-10">
                  <a
                    ...
                    className="p-2.5 bg-white dark:bg-dark-elevated rounded-lg hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-gray-900 transition-all border border-gray-200 dark:border-dark-border cursor-pointer"
